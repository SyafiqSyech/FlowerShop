...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/loginregister.css')); ?>">
    ...
    <main class="main">
        ...
        <div class="left__container">
            <div class="inner__container">
                ...
                <!--==================== FORM ====================-->
                <form action="<?php echo e(route('authenticate')); ?>" method="POST" class="login__form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="box">
                        ...
                        <div class="input__form">
                            <input name="email" type="text" class="input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                                id="email" required placeholder=" " value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input__form">
                            <input name="password" type="password" class="input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="button__container">
                            ...
                            <a class="bottom__button button__content" id="register-btn" href="<?php echo e(route('register')); ?>">
                                <p>Register</p>
                            </a>
                        </div>
                    </div>
        ...
        <div class="right__container">
            ...
            <img src="<?php echo e(asset('img/login/LoginPlant.png')); ?>" alt="" class="image toprounded">
...
<?php /**PATH D:\Coding Project\Website\FlowerShop\resources\views/auth/login.blade.php ENDPATH**/ ?>