    ...
    <main class="main">
        ...
        <section class="featured section" id="featured">
            ...
            <div class="container__card">
                <?php $__empty_1 = true; $__currentLoopData = $featuredHerbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featuredHerbs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('layouts.cardContainer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <section class="new__collection section" id="new-collection">
            ...
            <div class="newcollect__left-container">
                <img src="<?php echo e(asset('img/newcollect-pict.png')); ?>" alt="">
            </div>
            ...
            <div class="collection__big-container">
                <div class="collection__container">
                    <div class="collection__image">
                        <img src="<?php echo e(asset('img/collection-exotic.png')); ?>" alt="" class="collection__img">
                    </div>
                ...
                <div class="collection__container">
                    <div class="collection__image">
                        <img src="<?php echo e(asset('img/collection-swiftgrow.png')); ?>" alt=""
                ...
                <div class="collection__container">
                    <div class="collection__image">
                        <img src="<?php echo e(asset('img/collection-alchemical.png')); ?>" alt=""
                            class="collection__img">
                    </div>
        ...
        <section class="testimony__carousel section" id="testimony-carousel">
            <div id="carouselExampleCaptions" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <img src="<?php echo e(asset('img/testimony-pict.png')); ?>" class="carousel-img d-block w-100"
        ...
        <section class="advantages section" id="advantages">
            <div class="advantages__container">
                <img src="<?php echo e(asset('img/icon/lucide_phone-call.png')); ?>" alt=""
            ...
            <div class="advantages__container">
                <img src="<?php echo e(asset('img/icon/lucide_truck.png')); ?>" alt="" class="advantages__icon-img">
            ...
            <div class="advantages__container">
                <img src="<?php echo e(asset('img/icon/lucide_badge-check.png')); ?>" alt=""
                    class="advantages__icon-img">
            ...
            <div class="advantages__container">
                <img src="<?php echo e(asset('img/icon/lucide_award.png')); ?>" alt="" class="advantages__icon-img">
        ...
        <section class="ourStory section" id="ourStory">
            <div class="ourStory__container">
                <div class="ourStory__left-container">
                    <img src="<?php echo e(asset('img/ourStory-pict.png')); ?>" alt="" class="ourStory__img">
...
<?php /**PATH D:\Coding Project\Website\FlowerShop\resources\views/main/landing-page.blade.php ENDPATH**/ ?>