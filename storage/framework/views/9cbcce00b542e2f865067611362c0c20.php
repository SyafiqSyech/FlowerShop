    ...
    <main class="main">
        ...
        <!-- <nav class="header__home" id="headerHome">
            ...
            <ul class="nav__list-mid">
                <li class="nav__item">
                    <a href="<?php echo e(route('home')); ?>" class="nav__link hover-underline-animation">Home</a>
                </li>

                <li class="nav__item">
                    <a href="<?php echo e(route('herbs')); ?>" class="nav__link">Herbs</a>
                </li>

                <li class="nav__item">
                    <a href="<?php echo e(route('contact')); ?>" class="nav__link">Contact</a>
                </li>
            </ul>

            <ul class="nav__list-right">
                <li class="nav__item">
                    <a href="<?php echo e(route('cart')); ?>" class="nav__link">Cart</a>
                </li>
                <li class="nav__item">
                    <a href="<?php echo e(route('account')); ?>" class="nav__link">Account</a>
                </li>
            </ul>
        </nav> -->
                        ...
                        <div class="right_section_details">
                            <div class="first_last_name">
                                <div class="information__container">
                                    ...
                                    <div class="information__content"><?php echo e(auth()->user()->firstName); ?></div>
                                </div>
                                <div class="information__container">
                                    <div class="information__title">Last Name</div>
                                    <div class="information__content"><?php echo e(auth()->user()->lastName); ?></div>
                                </div>
                            </div>
                            <div class="information__container">
                                <div class="information__title">Email</div>
                                <div class="information__content"><?php echo e(auth()->user()->email); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="details_content">
                        ...
                        <div class="right_section_details">
                            <div class="information__container">
                                ...
                                <div class="information__content information__content-empty"><?php echo e(auth()->user()->phoneNumber); ?></div>
                            </div>
                            <div class="information__container">
                                <div class="information__title">Date of Birth</div>
                                <div class="information__content information__content-empty"><?php echo e(auth()->user()->DOB); ?></div>
                            </div>
                            <div class="information__container">
                                ...
                                <div class="information__content-radio">
                                    <div class="gender_radio_button">
                                        <div class="radio_button">
                                            <input type="radio" id="male" value="Male" <?php echo e(auth()->user()->gender == 'Male' ? 'checked' : ''); ?>>
                                        </div>
                                    ...
                                    <div class="gender_radio_button">
                                        <div class="radio_button radio_button-selected">
                                            <input type="radio" id="perempuan" value="Female" <?php echo e(auth()->user()->gender == 'Female' ? 'checked' : ''); ?>>
                                        </div>
        ...
        <img src="<?php echo e(asset('img/bottom-account.png')); ?>" alt="" class="img-account-bottom">
    </main>
...
<?php /**PATH D:\Coding Project\Website\FlowerShop\resources\views/main/account.blade.php ENDPATH**/ ?>