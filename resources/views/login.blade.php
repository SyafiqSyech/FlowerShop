                ...
                <form action="{{ route('authenticate')}}" method="POST" class="login__form">
                    ...
                    <div class="login__box">
                        ...
                        <div class="input__form">
                            <input name="email" type="text" class="login__input @error('email') is-invalid @enderror" id="email" required placeholder=" ">
                        ...
                        <div class="input__form">
                            <input name="password" type="password" class="login__input @error('paassword') is-invalid @enderror" id="password" required placeholder=" ">
                        ...
                        <div class="button__container">
                            ...
                            <a class="register__button button" id="register-btn" href="{{ route('register')}}">Register</a>
